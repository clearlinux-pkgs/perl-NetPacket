...
Source0  : https://cpan.metacpan.org/authors/id/Y/YA/YANICK/NetPacket-1.7.1.tar.gz
...
%prep
%setup -q -n NetPacket-1.7.1
cd ..
%setup -q -T -D -n NetPacket-1.7.1 -b 1
mkdir -p deblicense/
cp -r %{_topdir}/BUILD/debian/* %{_topdir}/BUILD/NetPacket-1.7.1/deblicense/
